...
print(f"result1: {evaluate_math_expr('-7 * -(6 / 2)')}")

tic = time.perf_counter()

print(f"result2: {evaluate_math_expr('(35 - (46 * (7.7 - 1.12 / (6 * 97 - 3.36)) - -74 * -(59 + 1 - 98) / -31 + -58) * -61 - 7 * (1 + 2 * 6.6666))/(3 * 366.98 / (2 + 2 * 2) + 98.98) + 989')}")
